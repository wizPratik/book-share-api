export class LocationProvider {
  static readonly CITY_STATE_MAP = [
  ...
  static readonly CITIES = this.CITY_STATE_MAP.map((e) => e.city);

  static readonly STATES = this.CITY_STATE_MAP.map((e) => e.state);

  static readonly STATE_CITY_MAP = this.CITY_STATE_MAP.reduce(
    (map: Record<string, string[]>, { city, state }) => {
      map[state] = (map[state] || []).concat(city);
      return map;
    },
    {},
  );
