...
public @interface UserEmailUnique {
    ...
    final class UserEmailUniqueValidator implements ConstraintValidator<UserEmailUnique, String> {

        private final UserService userService;
        private final HttpServletRequest request;

        UserEmailUniqueValidator(final UserService userService1, final HttpServletRequest request1) {
